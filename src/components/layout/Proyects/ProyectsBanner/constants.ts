export const PROYECTSBANNER_TITLE = " PROYECTO ";
export const PROYECTS_BANNER_P1 = `At vero eos et accusamus et iusto odio dignissimos ducimus 
...
export const PROYECTS_BANNER_P2 = `At vero eos et accusamus et iusto odio dignissimos ducimus 
qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas
 molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa
  qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem
  rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi
